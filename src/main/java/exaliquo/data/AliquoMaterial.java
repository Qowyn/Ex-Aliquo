...
public enum AliquoMaterial {
	...
	private final ToolMaterial fallback;
	private final String[] names;
	
	private AliquoMaterial(ToolMaterial fallback, String... altNames) {
	...
	public ToolMaterial getToolEnumFromRecipe() {
	...
	public ToolMaterial getFallbackToolEnum() {
	...
	private static final Function<String, InventoryCrafting> PICKAXE_CRAFTING =
		...
		@Override public InventoryCrafting apply(String input) {
			...
			for (int i : new int[] {4, 5})
				inv.setInventorySlotContents(i, new ItemStack(Items.stick));
			return inv;
		}
	};
